...
public:
    ...
    static Matrix3d RotMatBodyToBody(Matrix3d prevRotMat, Matrix3d curRotMat);
    // The timestep
    ...
    static Vector3d GetAngularVelVec(Matrix3d prevRotMat, Matrix3d curRotMat, double deltaT);
};
